...
.kpi-card:hover {
    ...
    border-color: #00f3ff;
    box-shadow: 0 20px 60px rgba(102, 126, 234, 0.4), 0 0 40px rgba(0, 243, 255, 0.3);
}
...
@keyframes alertPulse {
    0%, 100% { box-shadow: 0 10px 20px -5px rgba(139, 69, 19, 0.4); }
    50% { box-shadow: 0 10px 30px rgba(139, 69, 19, 0.6); }
}
